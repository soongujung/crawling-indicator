...
if __name__ == '__main__':
    url = "http://ecos.bok.or.kr/api/StatisticSearch/{}/json/kr/1/50000/I10Y014/MM/19600101/20201231/KR".format(
        api_key)
    ...
    df_loan_rate_insert.to_sql(name='loan_rate_kor',
                               con=alchemy_conn,
                               index=False,
                               index_label='TIME',
    ...
    df_loan_rate = pandas_sql.read_sql_query("select * from loan_rate_kor", alchemy_conn)
    print("database result ::: loan_rate_kor")
    print(df_loan_rate)
    ...
    df_alternative.to_sql(name='loan_rate_kor',
                               con=alchemy_conn,
                               index=False,
                               index_label='TIME',
